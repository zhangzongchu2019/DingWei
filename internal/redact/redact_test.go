...
func TestContentRedactsSecretsAndPhone(t *testing.T) {
	in := `{"token":"abc123","password":"pw","api_key":"sk-1234567890abcd","text":"Bearer abc.def.ghi phone 17607679850"}`
	out := Content(in)
	for _, forbidden := range []string{"abc123", `"pw"`, "sk-1234567890abcd", "abc.def.ghi", "17607679850"} {
