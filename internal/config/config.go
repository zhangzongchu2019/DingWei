...
type Bootstrap struct {
	...
	FeishuBotChannelID   string // UnifiedRobot 默认管道 ID
...
func LoadBootstrap() Bootstrap {
	...
	return Bootstrap{
		...
		ScheduleTeamFile:     env("WP_SCHEDULE_TEAM_FILE", "docs/AI研究任务排期/AI-研究工作内容清单.md"),
		SchedulePersonalDir:  env("WP_SCHEDULE_PERSONAL_DIR", "docs/AI研究任务排期"),
