...
func TestR14P1_DefaultProjectFallback(t *testing.T) {
	...
	sourceUnknown := model.Message{ChatType: model.ChatGroup, ChatEntityID: "examplebot:group:oc_unknown999"}
	...
	sourceKnown := model.Message{ChatType: model.ChatGroup, ChatEntityID: "examplebot:group:oc_knownChat"}
